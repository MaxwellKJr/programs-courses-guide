...
const Faculty = ({ faculties, programs }) => {
  return (
    <>
      ...
      <section className="flex flex-row justify-center items-center pt-40 sm:pt-28 pb-20 lg:pt-40 text-white h-auto bg-gradient-to-br from-yellow-300 via-blue-500 to-blue-400">
